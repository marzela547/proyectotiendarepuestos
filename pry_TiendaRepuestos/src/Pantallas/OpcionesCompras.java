 ...
 * @author marce
 */
public class OpcionesCompras extends javax.swing.JDialog {

    /**
     * Creates new form OpcionesCompras
     */
    public OpcionesCompras(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        ImageIcon lista = new ImageIcon(getClass().getResource("/Imagenes/compraslis.png"));
        ...
        ImageIcon nuevo = new ImageIcon(getClass().getResource("/Imagenes/nuevacompra.png"));
    ...
    private void btnlistarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnlistarActionPerformed
        HistorialCompras pantalla = new HistorialCompras();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                OpcionesCompras dialog = new OpcionesCompras(new javax.swing.JFrame(), true);
